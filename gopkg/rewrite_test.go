...
func TestUnqualify(t *testing.T) {
	var cases = []struct {
		...
		{"C", "C"},
		{"D/Gopkgs/_workspace/src/T", "T"},
		{"C/Gopkgs/_workspace/src/D/Gopkgs/_workspace/src/T", "T"},
	}
...
import "C/Gopkgs/_workspace/src/D"
...
func TestRewrite(t *testing.T) {
	...
	var cases = []struct {
		...
		{ // intermediate dep that uses gopkg save -r
			cwd:   "C",
			paths: []string{"D", "T"},
			start: []*node{
				{"C/main.go", pkg("main", "D"), nil},
				{"C/Gopkgs/_workspace/src/D/main.go", pkg("D", "D/Gopkgs/_workspace/src/T"), nil},
				{"C/Gopkgs/_workspace/src/T/main.go", pkg("T"), nil},
			},
			want: []*node{
				{"C/main.go", pkg("main", "C/Gopkgs/_workspace/src/D"), nil},
		...
		{ // intermediate dep that uses gopkg save -r, -r=false
			cwd: "C",
			start: []*node{
				{"C/main.go", pkg("main", "D"), nil},
				{"C/Gopkgs/_workspace/src/D/main.go", pkg("D", "D/Gopkgs/_workspace/src/T"), nil},
