...
func gopkgs(importpath string, keyval ...string) *Gopkgs {
	g := &Gopkgs{
	...
	var cases = []struct {
		...
		{ // simple case, one dependency
			...
			want: []*node{
				...
				{"C/Gopkgs/_workspace/src/D/main.go", pkg("D"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
				Deps: []Dependency{
		...
		{ // transitive dependency
			...
			want: []*node{
				{"C/main.go", pkg("main", "D"), nil},
				{"C/Gopkgs/_workspace/src/D/main.go", pkg("D", "T"), nil},
				{"C/Gopkgs/_workspace/src/T/main.go", pkg("T"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
				Deps: []Dependency{
		...
		{ // two packages, one in a subdirectory
			...
			want: []*node{
				...
				{"C/Gopkgs/_workspace/src/D/main.go", pkg("D"), nil},
				{"C/Gopkgs/_workspace/src/D/P/main.go", pkg("P"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
				Deps: []Dependency{
		...
		{ // repo root is not a package (no go files)
			...
			want: []*node{
				...
				{"C/Gopkgs/_workspace/src/D/P/main.go", pkg("P"), nil},
				{"C/Gopkgs/_workspace/src/D/Q/main.go", pkg("Q"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
				Deps: []Dependency{
		...
		{ // add one dependency; keep other dependency version
			...
			want: []*node{
				...
				{"C/Gopkgs/_workspace/src/E/main.go", pkg("E"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
				Deps: []Dependency{
		...
		{ // remove one dependency; keep other dependency version
			...
			want: []*node{
				{"C/Gopkgs/_workspace/src/D/main.go", pkg("D") + decl("D1"), nil},
				{"C/Gopkgs/_workspace/src/E/main.go", "(absent)", nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
				Deps: []Dependency{
			...
			start: []*node{
				...
				},
				{
					...
					[]*node{
						...
						{"Gopkgs/Gopkgs.json", gopkgs("C", "D/A", "D1"), nil},
						{"Gopkgs/_workspace/src/D/A/main.go", pkg("A") + decl("A1"), nil},
						{"+git", "", nil},
					},
				},
			},
			want: []*node{
				{"C/Gopkgs/_workspace/src/D/A/main.go", pkg("A") + decl("A1"), nil},
				{"C/Gopkgs/_workspace/src/D/B/main.go", pkg("B") + decl("B1"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
				Deps: []Dependency{
		...
		{ // replace dependency from same repo child dir
			...
			want: []*node{
				{"C/Gopkgs/_workspace/src/D/main.go", "(absent)", nil},
				{"C/Gopkgs/_workspace/src/D/A/main.go", pkg("A") + decl("A1"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
		...
		{ // Bug https://github.com/tools/gopkg/issues/85
			cwd: "C",
			start: []*node{
				{
					"D",
				...
				},
				{
					...
					[]*node{
						...
						{"Gopkgs/_workspace/src/D/A/main.go", pkg("A") + decl("A1"), nil},
						{"Gopkgs/_workspace/src/D/B/main.go", pkg("B") + decl("B1"), nil},
						{"+git", "", nil},
					},
				},
			},
		...
		{ // intermediate dependency that uses gopkg save -r, main -r=false
			cwd: "C",
			start: []*node{
				{
					"C",
				...
				},
				{
					...
					"",
					[]*node{
						{"main.go", pkg("D", "D/Gopkgs/_workspace/src/T"), nil},
						{"Gopkgs/_workspace/src/T/main.go", pkg("T"), nil},
						{"Gopkgs/Gopkgs.json", gopkgs("D", "T", "T1"), nil},
						{"+git", "D1", nil},
					},
				},
			},
		...
		{ // intermediate dependency that uses gopkg save -r, main -r too
			cwd:   "C",
			flagR: true,
			start: []*node{
				{
			...
			want: []*node{
				{"C/main.go", pkg("main", "C/Gopkgs/_workspace/src/D"), nil},
				{"C/Gopkgs/_workspace/src/D/main.go", pkg("D", "C/Gopkgs/_workspace/src/T"), nil},
				{"C/Gopkgs/_workspace/src/T/main.go", pkg("T"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
		...
		{ // rewrite files under build constraints
			...
			want: []*node{
				{"C/main.go", pkg("main", "C/Gopkgs/_workspace/src/D"), nil},
				{"C/x.go", "// +build x\n\n" + pkg("main", "C/Gopkgs/_workspace/src/D"), nil},
				{"C/Gopkgs/_workspace/src/D/main.go", pkg("D"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
		...
		{ // exclude dependency subdirectories even when obtained by a rewritten import path
			...
			start: []*node{
				...
				},
				{
					...
					"",
					[]*node{
						{"main.go", pkg("D", "D/Gopkgs/_workspace/src/T/X"), nil},
						{"Gopkgs/_workspace/src/T/X/main.go", pkg("X"), nil},
						{"Gopkgs/Gopkgs.json", gopkgs("D", "T/X", "T1"), nil},
						{"+git", "D1", nil},
					},
				},
			},
			want: []*node{
				...
				{"C/Gopkgs/_workspace/src/D/main.go", pkg("D", "T/X"), nil},
				{"C/Gopkgs/_workspace/src/T/main.go", pkg("T"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
		...
		{ // pull in minimal dependencies, see https://github.com/tools/gopkg/issues/93
			cwd:   "C",
			flagR: true,
			start: []*node{
				{
			...
			want: []*node{
				{"C/main.go", pkg("main", "C/Gopkgs/_workspace/src/D/X"), nil},
				{"C/Gopkgs/_workspace/src/D/X/main.go", pkg("X"), nil},
			},
			wdep: Gopkgs{
				ImportPath: "C",
				Deps: []Dependency{
